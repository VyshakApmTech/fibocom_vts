...
//C3
    ...
    fibo_gpio_mode_set(82,2);//SPI2
    fibo_gpio_mode_set(83,2);
    fibo_gpio_mode_set(84,2);
    fibo_gpio_mode_set(85,2);


    fibo_gpio_mode_set(103,2); //SPI1
    fibo_gpio_mode_set(104,2);
    fibo_gpio_mode_set(105,2);
    fibo_gpio_mode_set(106,2);
