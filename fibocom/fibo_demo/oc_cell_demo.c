...
static void oc_cell_demo_thread(void *param)
{
    ...
    //fibo_send_cmd(FIBO_CMD_SET_SIGNAL_QUALITY_URC, &config_signal_quality_urc, sizeof(fibo_nw_config_signal_quality_urc_t), NULL, NULL);
    while(1)
    {
...
{
    operator_info_t operator_info;
    fibo_send_cmd(FIBO_CMD_GET_OPERATOR_INFO,NULL,0,&operator_info,NULL);
