...
typedef enum
{
    ...
    GAPP_SIG_BLE_BOND_SUCCESS,
    GAPP_SIG_BLE_BOND_FAILED,
    GAPP_SIG_NW_JAMMING_DETECT_IND,
    GAPP_SIG_FTPMKD_SUCCESS,
    GAPP_SIG_FTPMKD_FAIL,
    GAPP_SIG_AP_POWERUP_ENABLE_FM_IND,
    GAPP_SIG_MAX,
} GAPP_SIGNAL_ID_T;
