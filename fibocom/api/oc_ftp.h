...
INT32 fibo_ftp_write_v1(char *server_path, char *local_path, uint32_t server_offset, uint32_t local_offset);
...
uint32_t fibo_ftp_size(char *server_path);
INT32 fibo_ftp_mkd(char *dir);
#endif
