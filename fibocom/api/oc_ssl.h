...
{
    FIBO_MD_NONE = 0,  /**< None. */
    FIBO_MD_MD2,       /**< The MD2 message digest. */
    FIBO_MD_MD4,       /**< The MD4 message digest. */
    FIBO_MD_MD5,       /**< The MD5 message digest. */
    FIBO_MD_SHA1,      /**< The SHA-1 message digest. */
    FIBO_MD_SHA224,    /**< The SHA-224 message digest. */
    FIBO_MD_SHA256,    /**< The SHA-256 message digest. */
    FIBO_MD_SHA384,    /**< The SHA-384 message digest. */
    FIBO_MD_SHA512,    /**< The SHA-512 message digest. */
    FIBO_MD_RIPEMD160, /**< The RIPEMD-160 message digest. */
} fibo_md_type_t; //ffw_md_type_t
...
INT32 fibo_ssl_sign(fibo_md_type_t md_type, bool hmac, const uint8_t *key, int key_len, const uint8_t *payload, int payload_len, uint8_t *result);
#endif
