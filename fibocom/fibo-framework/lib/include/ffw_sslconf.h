...
#ifndef FFW_SSL_SOCKET_CTX_ID_MAX
/// 最大的SOCKET ID
#define FFW_SSL_SOCKET_CTX_ID_MAX (6)
#endif
...
int ffw_sslconf_set_ignore_check_item(uint32_t id, uint32_t ignore_check_item);
int ffw_sslconf_get_ignore_check_item(uint32_t id, uint32_t* ignore_check_item);
