...
#if defined(CONFIG_FIBOCOM_8910_BASE)
    ffw_handle_t wifi_thread_handle;
    void* wifi_handle_queue;
    bool wifi_handle_timeout;
#endif
} ffw_wifi_context_t;
...
int ffw_wifiscan_handle(ffw_wifi_info_t* ap_info);
#endif
