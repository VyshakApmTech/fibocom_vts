...
#if defined(CONFIG_FFW_EC200_MQTT_AT_ENABLE)
int ffw_mqtt_send_connect_pkt(ffw_mqttc_t * client);
int ffw_mqttc_del_will(ffw_mqttc_t *client);
int ffw_mqttc_init_interface1(ffw_mqttc_interface_t *c, ffw_mqttc_interface_opt_t *opt);
#endif
