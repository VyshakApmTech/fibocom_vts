...
#define AT_SMS_CODE_7BIT 0
#define AT_SMS_CODE_8BIT 4
#define AT_SMS_CODE_UCS2 8
...
#ifdef CONFIG_FIBOCOM_KT_FEATURE
static bool atSmsIsPduValid(uint8_t *pPDUData, uint16_t *nPDULen, bool bReadOrListMsgFlag);
#else
