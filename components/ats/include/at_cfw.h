...
#define AT_CFGFN_MMICG "/at_MMICG.nv"
extern uint8_t mmicg_mode;
#endif
...
#if defined(CONFIG_FIBOCOM_BASE)
bool apiSetCFUNZEROProcessBySim(uint8_t sim);
bool apiSetCFUNONEProcessBySim(uint8_t sim);
#endif
...
//2025-02-06 Add Start, ZhengYisong, MTC0843-244, auto auth from SPCSS01445314.
#define AT_NW_ESM_USER_AUTHENTICATION_FAILED 0x1D

#define AUTH_PROT_PAP 1
#define AUTH_PROT_CHAP 2
#define AUTH_PROT_CHAP_ENCODE 3
#define AUTH_PROT_AUTO_PAPCHAP 4
//2025-02-06 Add End, ZhengYisong, MTC0843-244.
