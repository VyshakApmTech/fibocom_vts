...
//               This file is in accordance with unisoc's Application Protocol
...
#define API_SET_RPLMN_REQ                   ( HVY_API_GENERAL_IN + 0x59 )
#define API_CHECK_Timer3245_LENGTH_REQ        ( HVY_API_GENERAL_IN + 0x60 )
#define API_SET_MAX_ATT_FAIL_NUM_FOR_ABNORMAL_REQ ( HVY_API_GENERAL_IN + 0x61 )
#define API_GET_SCELL_SINR_REQ              ( HVY_API_GENERAL_IN + 0x62 )
#define API_DISABLE_LTE_PARA_REQ            ( HVY_API_GENERAL_IN + 0x63 )
#define API_USE_IMSIP_FILE_REQ              ( HVY_API_GENERAL_IN + 0x64 )
#define API_SET_DATASERVICE_HIGHPRIOR_IND            ( HVY_API_GENERAL_IN + 0x65 )
#define API_GET_MEAS_REPORT_REQ             ( HVY_API_GENERAL_IN + 0x66 )

#define API_UPDATE_OPLMNwACT_LIST_REQ   ( HVY_API_GENERAL_IN + 0x67 )
#define API_UPDATE_FPLMN_LIST_REQ      ( HVY_API_GENERAL_IN + 0x68 )
#define API_SET_T3247_MAX_TIMES_IND   ( HVY_API_GENERAL_IN + 0x69 )
#define API_ERRC_CDRX_RPT_CFG_REQ     ( HVY_API_GENERAL_IN + 0x70 )
// General: API -> MMI
...
#define API_CHECK_Timer3245_LENGTH_IND  ( HVY_API_GENERAL_OUT + 32 )
#define API_GET_SCELL_SINR_IND        ( HVY_API_GENERAL_OUT + 33 )
#define API_READ_SIM_ERROR_IND       ( HVY_API_GENERAL_OUT + 34 )
#define API_REPORT_DISABLE_LTE_IND ( HVY_API_GENERAL_OUT + 35 )
#define API_GET_MEAS_REPORT_CNF      ( HVY_API_GENERAL_OUT + 36 )
#define API_UPDATE_OPLMNwACT_LIST_CNF   ( HVY_API_GENERAL_OUT + 37 )
#define API_UPDATE_FPLMN_LIST_CNF   ( HVY_API_GENERAL_OUT + 38 )
#define API_TIMER_INFO_IND   ( HVY_API_GENERAL_OUT + 40 )
#define API_CDRX_RPT_IND     ( HVY_API_GENERAL_OUT + 41 )
...
#define API_ENG_EVENT_RPT_REDIREC_IND     ( HVY_API_NW_OUT + 0x14 )
#define API_GSM_NETWORK_REJ_CAUSE_IND ( HVY_API_NW_OUT + 0x15 )
...
#define API_SIM_SEND_LONGCMD_REQ     ( HVY_API_SIM_IN + 39)
...
#define API_SIM_SEND_LONGCMD_CNF         ( HVY_API_SIM_OUT + 35  )
...
#if defined(__IRAT__) || defined(FUNC_GSM_SUPPORT)
...
#define API_DISABLE_LTE_LIST_MAX_NUM 16
typedef struct
{
    u8 plmnNum;
    u8 regFailMaxNum;
    u8 supportInRoaming;
    u8 reserved;
    u8 plmn[API_DISABLE_LTE_LIST_MAX_NUM*3];
}api_disableLteParaReq_t;

typedef struct
{
    u8 cause;
}api_reportDisableLteInd_t;
#endif
...
================================================================================
*/
#define STOP_TYPE_NORMAL        0x00
#define STOP_TYPE_CLOSE_SIM     0x01
#define STOP_TYPE_AIRMODE       0x02
#define STOP_TYPE_RAT_CHANGE    0x04
#define STOP_TYPE_LOCAL_DETACH  0x08
...
#define API_NW_LIST_MODE_MANUAL 0
...
/*
================================================================================
  Structure  : api_ErrcIdlMeasOffsetSetReq_t
--------------------------------------------------------------------------------
  Direction  : MMI -> API
  Scope      : 
================================================================================
...
/*For bug 2322209*/
#define API_CAUSE_TYPE_ATTACH_NO_RESPONSE 5
#define API_CAUSE_TYPE_UPDATE_NO_RESPONSE 6
#define API_CAUSE_TYPE_SERVICE_NO_RESPONSE 7
#define API_CAUSE_TYPE_LOCAL_CAUSE    0xFF

#if defined (LTE_NBIOT_SUPPORT) || defined (LTE_SUPPORT)||defined(FUNC_GSM_SUPPORT)
typedef struct
{
    /*
    0	idle
...
struct {
    ...
    int  target_index;
    char remoteAddress[/*CSM_EVENT_STRING_SZ*/128 + 1];
}ect_transfer_info;
 #endif
...
typedef struct
{
 ...
 char remoteParticipants[/*CSM_EVENT_LONG_STRING_SZ*/511];
...
#define  API_SIM_RESET_OK_ESIM_NO_EFDIR      6
...
#define  API_SIM_D32_SLOW_DOWN         0x04
#define  API_SIM_RFU                   0xFF
...
/*
================================================================================
  Structure  : api_ImsAssociatedInfoInd_t 
--------------------------------------------------------------------------------
  Direction  : API -> MMI
  Scope      : Send Ims Associated Info to MMI
  Comment    :
================================================================================
*/typedef struct
{
    U8 nLength;
    char p_associated_uri[/*CSM_EVENT_STRING_SZ*/128 + 1];
}api_ImsAssociatedInfoInd_t;
...
typedef struct
{
    u8    readImsipFile;
    u8    useImsipFile;
}api_UseImsipFileReq_t;

typedef struct
{
    u8    setMaxAttFailNum;
}api_SetMaxAttFailNumForAbnormalReq_t;
...
{
    u32    length;
}api_CheckTimer3245LengthInd_t;

typedef struct
{
    u8    index;
}api_SetDataServiceHighPriorInd_t;
...
typedef struct
{
    T_ERRC_API_CDRX_RPT_IND cdrxRptInd;
}api_cdrxRptInd_t;
...
#define API_WHITE_BLACK_PLMN_NUM   30
typedef struct
{
    u8 nMode;
    u8 ltePlmnNum;
...
#define SIM_FILE_MAX_PLMN_SEL_LEN    253

/*
================================================================================
  Structure  : api_UpdateOPLMNwACTlistReq_t
--------------------------------------------------------------------------------
  Direction  : CFW -> API
  Scope      : 
  Comment    : refresh_31124_27.22.4.7.3.3_case
================================================================================
*/
typedef struct api_UpdateOPLMNwACTlistReq_t_tag
{
    u8 length;
    u8 OPLMNwACT[SIM_FILE_MAX_PLMN_SEL_LEN];    
}api_UpdateOPLMNwACTlistReq_t;

/*
================================================================================
  Structure  : api_UpdateFPLMNlistReq_t
--------------------------------------------------------------------------------
  Direction  : CFW -> API
  Scope      : 
  Comment    : refresh_31124_27.22.4.7.3.3_case
...
typedef struct api_UpdateFPLMNlistReq_t_tag
{
    u8 length;
    u8 fplmn[SIM_FILE_MAX_PLMN_SEL_LEN];                 
}api_UpdateFPLMNlistReq_t;    

/*
================================================================================
  Structure  : api_UpdateFPLMNlistCnf_t
--------------------------------------------------------------------------------
  Direction  : API -> CFW
  Scope      : 
  Comment    : refresh_31124_27.22.4.7.3.3_case
...
typedef struct api_UpdateFPLMNlistCnf_t_tag
{
    u8 result;                 
} api_UpdateFPLMNlistCnf_t;  

//#ifdef _LTE_GNSS_WIFISCAN_
...
{
    u8 simCardErrorFlag;
}api_readSimErrorInd_t;


typedef struct
{
u8 PD;  // MM_MMC_PD  CMN_MMP_PD
u8 msg;
u8 cause;
u8   Bsic;
u16  Arfcn;
u8 Rai[6];
}api_GsmNetworkRejCause_t;
// according 24008
#define MM_MSG_LU_REJ    0x04
#define MM_MSG_SERVICE_REJ  0x22
#define MM_MSG_AUTH_REJ 0x11
#define MMP_MSG_ATTACH_REJ  0x04
#define MMP_MSG_RAU_REJ 0x0b
#define MMP_MSG_AUTH_REJ 0x14

typedef struct api_getMeasReportReq_t_tag
{
    u8 mode;       //0 for intra;1 for inter        
}api_getMeasReportReq_t;

typedef struct api_getMeasReportCnf_t_tag
{
    uint8     measReportLen; /*air message payload length*/
	uint8     measReport[100];                 
}api_getMeasReportCnf_t;
