...
#define EV_CFW_RF_FLASH_CLKSHIFT_REQ (EV_CFW_EMOD_BASE + 3)
...
#define EV_CFW_IMS_ASSOCIATED_INFO_IND (EV_CFW_IND_BASE + 96)

#define EV_CFW_TIMER_INFO_IND (EV_CFW_IND_BASE + 98)
//
// Emulator Event
//
...
#define EV_CFW_NW_GET_NET_SCHE_INFO_RSP (EV_CFW_NW_RSP_BASE + 28)
...
#define EV_TCPIP_CFW_GPRS_AUTO_DEACT (EV_CFW_GPRS_RSP_BASE + 16) //modify by fibocom
...
#define EV_CFW_SAT_STEERING_ROAMING_RSP (EV_CFW_SIM_RSP_BASE + 71)
