...
//Block lock
#define F_CMP (REG_BIT(1))
#define F_INV (REG_BIT(2))
#define F_BP0 (REG_BIT(3))
#define F_BP1 (REG_BIT(4))
#define F_BP2 (REG_BIT(5))
#define F_BRWD (REG_BIT(7))

//OTP
#define F_QE (REG_BIT(0))
#define F_BUF_EN (REG_BIT(3))
#define F_ECC_EN (REG_BIT(4))
#define F_OTP_EN (REG_BIT(6))
#define F_OTP_PRT (REG_BIT(6))

//Status
#define F_OIP (REG_BIT(0))
#define F_WEL (REG_BIT(1))
#define F_E_FAIL (REG_BIT(2))
#define F_P_FAIL (REG_BIT(3))
#define F_ECCS0 (REG_BIT(4))
#define F_ECCS1 (REG_BIT(5))
#define F_ECCS2 (REG_BIT(6))
