...
#define HAL_TIMER_IRQ_NUM HAL_SYSIRQ_NUM(SYS_IRQ_ID_TIMER_4_OS)
#define HAL_TIMER_IRQ_PRIO SYS_IRQ_PRIO_TIMER_4_OS
...
OSI_FORCE_INLINE static void halTimerEnable(void)
{
    ...
    REGT_FIELD_WRITE(hwp_timer4->timer_irq_mask_set,
...
OSI_FORCE_INLINE static void halTimerReload(int64_t loadval)
{
    ...
    hwp_timer4->ostimer_ctrl = 0;
    hwp_timer4->ostimer_loadval_l = (uint32_t)loadval;
    REGT_FIELD_WRITE(hwp_timer4->ostimer_ctrl,
...
{
    unsigned hi = hwp_timer4->hwtimer_curval_h;
    unsigned lo = hwp_timer4->hwtimer_curval_l;
    unsigned hi_next = hwp_timer4->hwtimer_curval_h;
    if (hi_next != hi)
        lo = hwp_timer4->hwtimer_curval_l;
