...
#define REG_GIC400_BASE (0x08200000)
...
// gicd_igrouprn
#define GIC400_GROUP_STATUS_BITS(n) (((n)&0xffffffff) << 0)

// gicd_isenabler0
#define GIC400_SET_ENABLE_BITS(n) (((n)&0xffffffff) << 0)
...
// gicd_icenabler0
#define GIC400_CLEAR_ENABLE_BITS(n) (((n)&0xffffffff) << 0)
...
// gicd_ispendrn
#define GIC400_SET_PENDING_BITS(n) (((n)&0xffffffff) << 0)

// gicd_icpendrn
#define GIC400_CLEAR_PENDING_BITS(n) (((n)&0xffffffff) << 0)

// gicd_isactivern
#define GIC400_SET_ACTIVE_BITS(n) (((n)&0xffffffff) << 0)

// gicd_icactivern
#define GIC400_CLEAR_ACTIVE_BITS(n) (((n)&0xffffffff) << 0)

// gicd_ipriorityrn
#define GIC400_GICD_IPRIORITYRN_PRIORITY(n) (((n)&0xffffffff) << 0)

// gicd_itargetsr0
#define GIC400_CPU_TARGETS(n) (((n)&0xffffffff) << 0)
...
// gicd_icfgr0
#define GIC400_INT_CONFIG(n) (((n)&0xffffffff) << 0)
...
// gicd_spisrn
#define GIC400_SPIS_STATUS(n) (((n)&0xffffffff) << 0)

// gicd_nsacrn
#define GIC400_NS_ACCESS(n) (((n)&0xffffffff) << 0)
...
// gicd_cpendsgirn
#define GIC400_SGI_CLEAR_PENDING(n) (((n)&0xffffffff) << 0)

// gicd_spendsgirn
#define GIC400_SGI_SET_PENDING(n) (((n)&0xffffffff) << 0)
...
// gicc_pmr
#define GIC400_GICC_PMR_PRIORITY(n) (((n)&0xff) << 0)
...
// gicc_rpr
#define GIC400_GICC_RPR_PRIORITY(n) (((n)&0xff) << 0)
...
// gicc_aprn
#define GIC400_ACTIVE_PRIORITY(n) (((n)&0xffffffff) << 0)

// gicc_nsaprn
#define GIC400_NS_ACTIVE_PRIORITY(n) (((n)&0xffffffff) << 0)
