...
// Auto generated (v1.0-97-ga91c9f8). Don't edit it manually!
...
typedef union {
    ...
    struct
    {
        ...
        uint32_t asesvld : 1;         // [18], read only
...
typedef union {
    ...
    struct
    {
        ...
        uint32_t ulpi_utmi_sel : 1;  // [4], read only
        uint32_t fsintf : 1;         // [5]
        uint32_t physel : 1;         // [6]
        uint32_t __7_7 : 1;          // [7]
        uint32_t srpcap : 1;         // [8]
...
typedef union {
    ...
    struct
    {
        uint32_t chnum : 4;   // [3:0], read only
        uint32_t bcnt : 11;   // [14:4], read only
        uint32_t dpid : 2;    // [16:15], read only
        uint32_t pktsts : 4;  // [20:17], read only
...
typedef union {
    ...
    struct
    {
        ...
        uint32_t srpdetect : 1;     // [15]
        uint32_t srpdetectmsk : 1;  // [16]
        uint32_t stschngint : 1;    // [17]
...
typedef union {
    ...
    struct
    {
        ...
        uint32_t adpen : 1;        // [20]
        uint32_t adpprbint : 1;    // [21]
        uint32_t adpsnsint : 1;    // [22]
        uint32_t adptoutint : 1;   // [23]
...
typedef union {
    ...
    struct
    {
        ...
        uint32_t prtconndet : 1;     // [1]
        uint32_t prtena : 1;         // [2]
        uint32_t prtenchng : 1;      // [3]
        uint32_t prtovrcurract : 1;  // [4], read only
        uint32_t prtovrcurrchng : 1; // [5]
        uint32_t prtres : 1;         // [6]
...
typedef union {
    ...
    struct
    {
        ...
        uint32_t ack : 1;               // [5]
        uint32_t nyet : 1;              // [6]
        uint32_t xacterr : 1;           // [7]
        uint32_t bblerr : 1;            // [8]
        uint32_t frmovrun : 1;          // [9]
        uint32_t datatglerr : 1;        // [10]
        uint32_t bnaintr : 1;           // [11]
        uint32_t xcs_xact_err : 1;      // [12]
        uint32_t desc_lst_rollintr : 1; // [13]
...
typedef union {
    ...
    struct
    {
        ...
        uint32_t soffn : 14;    // [21:8], read only
...
typedef union {
    ...
    {
        uint32_t xfercompl : 1;   // [0]
        uint32_t epdisbld : 1;    // [1]
        uint32_t ahberr : 1;      // [2]
        uint32_t timeout : 1;     // [3]
        uint32_t intkntxfemp : 1; // [4]
        uint32_t intknepmis : 1;  // [5]
        uint32_t inepnakeff : 1;  // [6]
        uint32_t txfemp : 1;      // [7], read only
        uint32_t txfifoundrn : 1; // [8]
        uint32_t bnaintr : 1;     // [9]
        uint32_t __10_10 : 1;     // [10]
        uint32_t pktdrpsts : 1;   // [11]
        uint32_t bbleerr : 1;     // [12]
        uint32_t nakintrpt : 1;   // [13]
        uint32_t nyetintrpt : 1;  // [14]
        uint32_t __31_15 : 17;    // [31:15]
    } b;
} REG_USBC_DIEPINT0_T;
