...
typedef enum
{
    ...
    AUDEV_TONE_FREQ,        ///< fibo_audio_auto_play_freq_tone MTC0789-158
#endif
} audevTone_t;
 ...
 */
#ifdef CONFIG_FIBOCOM_FREQ_TONE_SUPPORT
extern uint16_t gDtmfToneFreq[20][2];
#else
...
typedef enum
{
    ...
    AUDEV_PLAY_TYPE_POC,
    /**    
     * Play to local ring-back during voice call.    
     */
    AUDEV_PLAY_TYPE_RINGBACK,
} audevPlayType_t;
