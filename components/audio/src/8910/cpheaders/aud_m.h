...
typedef enum
{
    ...
    /// For audio test loop; analog to DAI loop + DAI to analog loop.
    CODEC_TEST_LOOP_LINE,

    /// For audio test loop; radio loop on DAI interface
    CODEC_TEST_LOOP_ANALOG,

    /// For audio test loop; radio loop on analog interface
    CODEC_TEST_LOOP_ADC2DAC,
...
//  aud_SetAudDeviceCFG
// -----------------------------------------------------------------------------
/// Set audio device config.
///
/// @param cfg audio device config
// =============================================================================
...
PUBLIC HAL_AIF_FREQ_T aud_GetLatestSampleRate(VOID);
...
/// aud_SetBtNRECFlag
// =============================================================================
PUBLIC VOID aud_SetBtNRECFlag(UINT32 flag);
...
/// aud_GetBtNRECFlag
// =============================================================================
PUBLIC UINT32 aud_GetBtNRECFlag(VOID);
...
/// aud_SetLoopTestFlag
// =============================================================================
PUBLIC VOID aud_SetLoopTestFlag(UINT32 flag);
...
// aud_ItfToPath
// -----------------------------------------------------------------------------
/// convert the itf to app path.
///
/// @param mode: app mode.itf:AUD interface
/// @return app path
// =============================================================================
...
// aud_PathToItf
// -----------------------------------------------------------------------------
/// convert the app path to itf.
///
/// @param mode: app mode.path:app path
...
/// aud_SetUpdateCalibValueFlag
// =============================================================================
PUBLIC VOID aud_SetUpdateCalibValueFlag(BOOL flag);
...
// =============================================================================
//aud_SetCalibVerifyFlag
// -----------------------------------------------------------------------------
/// aud_SetCalibVerifyFlag
// =============================================================================
PUBLIC VOID aud_SetCalibVerifyFlag(UINT32 flag);
...
PUBLIC VOID aud_SetCloseDelayFlag(UINT32 en);

PUBLIC VOID aud_CodecNvInit(VOID);

#define AUD_CODEC_OUTPUT_QTY (3)
#define AUD_CODEC_INPUT_QTY (5)

// ============================================================================
// CAUD_CODEC_LOOPBACK_IN_GAIN_T
// -----------------------------------------------------------------------------
/// Loopback input (MIC) gains.
// =============================================================================
typedef struct
{
    // Input analog gain.
    int16_t ana; //0x00000000
    // Input ADC gain.
    int16_t adc;                //0x00000002
} AUD_CODEC_LOOPBACK_IN_GAIN_T; //Size : 0x4

// ============================================================================
// AUD_CODEC_LOOPBACK_OUT_GAIN_T
// -----------------------------------------------------------------------------
///Loopback output gains.
// =============================================================================
typedef struct
{
    // Output analog gain.
    int16_t ana; //0x00000000
    // Output DAC gain.
    int16_t dac; //0x00000002
    // Output ALG gain.
    int16_t alg; //0x00000004
    // Reserved.
    int16_t reserv;              //0x00000006
} AUD_CODEC_LOOPBACK_OUT_GAIN_T; //Size : 0x8
