...
//modify by fibocom 20241117 cq:SPCSS01258669/SPCSS01331669
#if defined(CONFIG_FIBOCOM_BASE) && !defined(CONFIG_FIBOCOM_8910_BASE) 
#define OSI_KERNEL_HOT_CODE OSI_SECTION_LINE(.sramtext.kernel)
#else
