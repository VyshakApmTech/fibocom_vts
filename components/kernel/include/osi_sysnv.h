...
#if defined(CONFIG_MC661_CN_19_70_YINGSHI) || defined(CONFIG_FIBOCOM_KT_FEATURE)
...
#elif defined(CONFIG_FIBOCOM_BASE)
OSI_SYSNV_VAR(int gSysnvUsbWorkMode, CONFIG_FIBOCOM_USB_DEFAULT_MODE); //default 2
#else
...
#if defined(CONFIG_FIBOCOM_INTERNAL_EXTERNAL_SHARE_IP) || defined(CONFIG_MG661_JP_29_20_ZETIAN) || defined(CONFIG_FIBOCOM_XLAT_SUPPORT)//8850 neiwaizhi use same netif or XLAT enable need AT+SYSNV=1,"nat_cfg",255
