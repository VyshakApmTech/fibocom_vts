...
#define DB_MAX_PAIRED_DEVICE_COUNT BT_MAX_PAIRED_DEVICE_COUNT
...
bt_stack_storage_t* DB_GetStorage(void);

void DB_SetVisibility(uint8 visibility);
uint8 DB_GetVisibility(void);
bt_status_t DB_RemovePairedInfo(bdaddr_t addr);
uint8 DB_GetPairedNum(void);
uint8  DB_GetPairedInfoFormIndex(uint8 index, bt_stack_device_info_t *bt_dm_device);
...
bt_status_t DB_AddWhiteInfo(ble_stack_white_list_t *WhiteInfo);
//uint8 DB_AddWhiteInfo(st_white_list_info *WhiteInfo);
bt_status_t DB_RemoveWhiteInfo(ble_stack_white_list_t *WhiteInfo);
...
ble_stack_white_list_t* DB_GetWhiteList(void);
bt_status_t DB_ClearWhitelist(void);
BT_STATUS BT_UpdateNV(void);
bt_status_t DB_SaveBtDevInfo(bt_conn_t *p_conn);
bt_status_t DB_SaveBleDevInfo(void);
bt_status_t DB_SaveBleSmpPairedInfo(ble_conn_t *p_conn);
bt_status_t DB_RemoveBlePairedInfo(bdaddr_t addr);
bt_status_t DB_ClearBleSmpPairedInfo(void);
