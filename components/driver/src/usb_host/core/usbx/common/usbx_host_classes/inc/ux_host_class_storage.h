...
#define UX_HOST_CLASS_STORAGE_THREAD_STACK_SIZE (4 * 1024)
#endif
...
#define UX_HOST_CLASS_STORAGE_THREAD_PRIORITY_CLASS OSI_HIGHER_PRIORITY_NORMAL
#else
#define UX_HOST_CLASS_STORAGE_THREAD_PRIORITY_CLASS OSI_PRIORITY_NORMAL
#endif
#define UX_HOST_CLASS_STORAGE_MAX_EVENT_NUM 32
#define UX_HOST_CLASS_STORAGE_TRANSFER_TIMEOUT 3000
...
typedef struct UX_HOST_CLASS_STORAGE_STRUCT
{
    ...
    (struct UX_HOST_CLASS_STORAGE_STRUCT *storage, UCHAR *data_pointer);
