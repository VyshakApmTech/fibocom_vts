...
#define LCD_DRV_ID_ST7789P3 0X8181b3
...
static const lcdOperations_t st7789p3Operations =
{
        _stInit,
        _stSleepIn,
        _stEsdCheck,
...
const lcdSpec_t g_lcd_st7789p3 =
{
        LCD_DRV_ID_ST7789P3,
        LCD_WIDTH,
        LCD_HEIGHT,
        ...
        LCD_CTRL_SPI,
        (lcdOperations_t *)&st7789p3Operations,
        false,
        0x2a000,
        50000000,
};
...
static uint32_t _stReadId(void)
{
    ...
    _lcdDelayMs(10);
#endif
    halGoudaReadConfig(g_lcd_st7789p3.bus_mode, g_lcd_st7789p3.is_use_fmark, g_lcd_st7789p3.fmark_delay);
    _lcdDelayMs(140);
