...
#define USB_PID_ECM_AND_SERIALS (0x4d11)
#else
...
typedef enum
{
    ...
    DRV_8850USB_UAC_AND_SERIALS = 0xD,
#ifdef CONFIG_FIBOCOM_BASE
    ...
    DRV_USB_HID_ACM,
    DRV_8850USB_HIDBULK_AND_AT,
    DRV_8850USB_HIDBULK,
    DRV_8850USB_HIDBULK_AND_AT_AT2,
    DRV_8850USB_BULK_AND_AT,
#endif
...
typedef void (*report_callback)(uint32_t rec_way,void* cb_ctx);
#endif

#ifdef CONFIG_FIBOCOM_USB_RECOVERY_REPORT

enum usb_recovery_way
{
    USB_RECOVERY_VBUSIN = 1,
    USB_RECOVERY_USBREST,
    USB_RECOVERY_USBSUSP_REST,
    USB_RECOVERY_USBWAY_THREE,
};
#endif
/**
