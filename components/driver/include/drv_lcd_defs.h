...
typedef enum
{
    ...
    DRV_LCD_DIR_2_ROTATE_0 = DRV_LCD_DIR_YINV,
    DRV_LCD_DIR_2_ROTATE_90 = DRV_LCD_DIR_EXCHG,
    DRV_LCD_DIR_2_ROTATE_180 = DRV_LCD_DIR_XINV,
    DRV_LCD_DIR_2_ROTATE_270 = DRV_LCD_DIR_EXCHG_XINV_YINV,
#endif
} drvLcdDirection_t;
