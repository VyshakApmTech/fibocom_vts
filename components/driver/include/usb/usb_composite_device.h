...
int printercopsAssignInterface(cops_t *c, copsFunc_t *f);
int bulkAtcopsAssignInterface(cops_t *c, copsFunc_t *f);
#endif
/**
...
#ifdef CONFIG_FIBOCOM_BASE
bool copsSetManufacturer(cops_t *c, char *mfr);
bool copsSetProduct(cops_t *c, char *pdt);
bool copsSetSerialNumber(cops_t *c, char *sn);
void copsSetDeviceClass(cops_t *c, uint8_t device);
#endif
...
#ifdef CONFIG_FIBOCOM_BASE 
void copsSetUsbBcd(cops_t *c, uint16_t bcd);
#endif
