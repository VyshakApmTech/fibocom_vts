...
typedef void (*f_vbus_callback)(uint32_t vbus_sta,void* cb_ctx);
struct vbus_report
{
    f_vbus_callback cb;
    void *cb_ctx;
};
typedef struct vbus_report usb_vbus_report_t;
int32_t ffw_usb_register_vbus_cb(f_vbus_callback cb,void* cb_ctx);
