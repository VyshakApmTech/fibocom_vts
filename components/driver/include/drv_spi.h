...
#endif
#ifdef CONFIG_FIBOCOM_8910_BASE
bool gpio_csEn;
uint8_t gpio_pinId;
...
int32_t fibo_adp_spi_open(drvSpiConfig_t cfg, SPIHANDLE *spiFd);
int32_t fibo_adp_spi_close(SPIHANDLE *spiFd);
int32_t fibo_adp_spi_send(SPIHANDLE spiFd, SPI_IOC spiIoc, void *sendaddr, uint32_t size);
int32_t fibo_adp_spi_recv(SPIHANDLE spiFd, SPI_IOC spiIoc, void *readaddr, uint32_t size);
int32_t fibo_adp_spi_send_rcv(SPIHANDLE spiFd, SPI_IOC spiIoc, void *sendaddr, void *readaddr, uint32_t size);
int32_t fibo_adp_spi_pinctrl(SPIHANDLE spiFd, drvSpiPinCtrl pinctrl, drvSpiPinState pinstate);
#endif
