...
static void prvSecureInit(void)
{
    ...
    OSI_LOGD(0x10009083, "romapi 0x%x %d hash 0x%x/0x%x/0x%x sig 0x%x decrypt 0x%x",
             gSecureCtx.romapi,
    ...
    halEfuseReadWriteOp_t efuse_ops[] = {
        {HAL_EFUSE_OP_DOUBLE_READ, HAL_EFUSE_DOUBLE_BLOCK_SECURITY_CFG, {.rval = &gSecureCtx.security_cfg}},
        {HAL_EFUSE_OP_DOUBLE_READ, HAL_EFUSE_DOUBLE_BLOCK_PUBKEY_0, {.rval = &gSecureCtx.pubkey[0]}},
        {HAL_EFUSE_OP_DOUBLE_READ, HAL_EFUSE_DOUBLE_BLOCK_PUBKEY_1, {.rval = &gSecureCtx.pubkey[1]}},
        {HAL_EFUSE_OP_DOUBLE_READ, HAL_EFUSE_DOUBLE_BLOCK_PUBKEY_2, {.rval = &gSecureCtx.pubkey[2]}},
        {HAL_EFUSE_OP_DOUBLE_READ, HAL_EFUSE_DOUBLE_BLOCK_PUBKEY_3, {.rval = &gSecureCtx.pubkey[3]}},
        {HAL_EFUSE_OP_DOUBLE_READ, HAL_EFUSE_DOUBLE_BLOCK_PUBKEY_4, {.rval = &gSecureCtx.pubkey[4]}},
        {HAL_EFUSE_OP_DOUBLE_READ, HAL_EFUSE_DOUBLE_BLOCK_PUBKEY_5, {.rval = &gSecureCtx.pubkey[5]}},
        {HAL_EFUSE_OP_DOUBLE_READ, HAL_EFUSE_DOUBLE_BLOCK_PUBKEY_6, {.rval = &gSecureCtx.pubkey[6]}},
        {HAL_EFUSE_OP_DOUBLE_READ, HAL_EFUSE_DOUBLE_BLOCK_PUBKEY_7, {.rval = &gSecureCtx.pubkey[7]}},
        {HAL_EFUSE_OP_DOUBLE_READ, HAL_EFUSE_DOUBLE_BLOCK_UID_0, {.rval = &gSecureCtx.unique_id[0]}},
        {HAL_EFUSE_OP_DOUBLE_READ, HAL_EFUSE_DOUBLE_BLOCK_UID_1, {.rval = &gSecureCtx.unique_id[1]}},
    };
    halEfuseReadWrite(efuse_ops, OSI_ARRAY_SIZE(efuse_ops));

    OSI_LOGD(0x10009084, "efuse 0x%08x 0x%08x 0x%08x 0x%08x 0x%08x 0x%08x 0x%08x 0x%08x 0x%08x 0x%08x 0x%08x",
...
void bootAntiCloneDecryption(void *buf, uint32_t len)
{
    ...
    // It is magic. The ROM code will access efuse directly, and it is
    // assumed that efuse controller is configured as single bit.
    REGT_FIELD_WRITE(hwp_efuseCtrl->efuse_sec_magic_number,
                     REG_EFUSE_CTRL_EFUSE_SEC_MAGIC_NUMBER_T,
                     sec_efuse_magic_number, 0x8910);
