...
if(CONFIG_FIBOCOM_SUPPORT_TWO_SPL)
    ...
    if(CONFIG_FIBOCOM_BASE)
        target_link_libraries(${target} PRIVATE fibo_logo_config)
        if(CONFIG_LCD_SUPPORT AND CONFIG_FIBOCOM_FW_UPDATE_LOGO_SUPPORT)
            message(STATUS "build fibo logo for spl2")
...
if(CONFIG_FIBOCOM_BASE)
    target_link_libraries(${target} PRIVATE fibo_logo_config)
    if(CONFIG_LCD_SUPPORT AND CONFIG_FIBOCOM_FW_UPDATE_LOGO_SUPPORT AND NOT CONFIG_FIBOCOM_SUPPORT_TWO_SPL)
        message(STATUS "build fibo logo for spl")
        target_link_libraries(${target} PRIVATE fibo_boot_logo lcdpanel)
        target_include_directories(${target} PRIVATE ../fibo_logo)
    endif()
endif()
