...
//#include "lwip/netif.h" //remove from fibocom for compile issue 20240806
#include "lwip/pbuf.h"
#include "tcpbase.h"  /*MTC0097-163  add H file to quote TCP state*/
...
typedef struct ip4_nat_entry_netif
{
    struct ip4_nat_entry_netif *next;
    ip4_nat_entry_t entry;
}ip4_nat_entry_netif_t;
#endif
