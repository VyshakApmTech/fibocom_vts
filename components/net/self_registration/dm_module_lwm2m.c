...
#include "fibocom.h"
#define DM_STARS "***"
#define DM_BRAND "Unisoc"
#define DM_MODEL "UIS8850EG"
#define DM_APPKEY "M100000058"
#define DM_APIVERSION "4.0.1"
#define DM_APITYPE "I"
#define DM_TEMPLATEID "TY000122"
#define DM_PWD "s2n7TgPkg3IT2oo51T630F3f6U5XJ6vj"
#define DM_DEFAULT_LIFETIME 1440 * 60
...
void dm_register(uint8_t nSimId)
{
    ...
    Options dm_config = {0};
    memcpy(dm_config.szBrand, (char *)DM_BRAND, strlen((char *)DM_BRAND));
    memcpy(dm_config.szModel, (char *)DM_MODEL, strlen((char *)DM_MODEL));

    memcpy(dm_config.szSdkVersion, (char *)DM_STARS, strlen((char *)DM_STARS));
    memcpy(dm_config.szApiVersion, (char *)DM_APIVERSION, strlen((char *)DM_APIVERSION));
    memcpy(dm_config.szApiType, (char *)DM_APITYPE, strlen((char *)DM_APITYPE));
    memcpy(dm_config.szTemplateId, (char *)DM_TEMPLATEID, strlen((char *)DM_TEMPLATEID));
    memcpy(dm_config.szCMEI_IMEI2, (char *)DM_STARS, strlen((char *)DM_STARS));
...
#else
    memcpy(dm_config.szAppKey, (char *)DM_APPKEY, strlen((char *)DM_APPKEY));
    memcpy(dm_config.szPwd, (char *)DM_PWD, strlen((char *)DM_PWD));
#endif
    ...
    snprintf(cmdline, sizeof(cmdline) - 1, "-e %d -n %s -W %s -h %s -p %s -4",
            LWM2M_SERVER_ONENET, deviceName, dm_pwd, host, port);
    ...
    if (lwm2m_register(gDMConnectRef, DM_DEFAULT_LIFETIME, 20) == LWM2M_RET_OK)
    {
