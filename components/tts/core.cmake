...
elseif(CONFIG_TTS_UNABRIDGED_DICTIONARY_SUPPORT)
set(import_lib ${out_lib_dir}/aisound50_BIG.a)
configure_file(aisound/lib/aisound50_BIG.a ${import_lib} COPYONLY)
add_app_libraries(${import_lib})
add_library(aisound50_BIG STATIC IMPORTED GLOBAL)
set_target_properties(aisound50_BIG PROPERTIES IMPORTED_LOCATION ${import_lib})
else()
