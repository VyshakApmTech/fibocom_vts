...
#if APP_MSBC_SUPPORT == 1
#define HF_FEATURE_CHOICE  (HF_FEATURE_CLIP|HF_FEATURE_CALL_WAIT|HF_FEATURE_VOICE_RECOGNITION|HF_FEATURE_REMOTE_VOL|HF_FEATURE_NREC_FUNCTION|HF_FEATURE_CODEC_NEGOTIATION|HF_FEATURE_HF_INDICATORS)
#define AG_FEATURE_CHOICE  (AG_FEATURE_THREE_WAY_CALLING|AG_FEATURE_NREC_FUNCTION|AG_FEATURE_REJECT_CALL|AG_FEATURE_ENHANCED_CALL_STATUS|AG_FEATURE_EXTENDED_ERROR_CODES|AG_FEATURE_CODEC_NEGOTIATION)
#define MSBC_SUPPOT_FLAG  1
#else
#define HF_FEATURE_CHOICE  (HF_FEATURE_CLIP|HF_FEATURE_CALL_WAIT|HF_FEATURE_VOICE_RECOGNITION|HF_FEATURE_REMOTE_VOL|HF_FEATURE_NREC_FUNCTION)
#define AG_FEATURE_CHOICE  (AG_FEATURE_THREE_WAY_CALLING|AG_FEATURE_NREC_FUNCTION|AG_FEATURE_REJECT_CALL|AG_FEATURE_ENHANCED_CALL_STATUS|AG_FEATURE_EXTENDED_ERROR_CODES)
#define MSBC_SUPPOT_FLAG  0
#endif

#define SMP_PASSKEY             (1<<4)
#define SMP_SECURITY_CONNECTION (1<<3)
#define SMP_MITM                (1<<2)
#define SMP_NO_BONDING          (0x00)
...
#define TGT_BT_STACK_CONFIG                             \
    {                                                   \
        ...
        {                                                   \
            ...
            .hci_cmd_timeout = 3000, /*timeout 3s*/         \
        },                                                  \
        .manager_config =                                   \
        {                                                   \
            .max_acl_links = 2,                             \
            .max_device_list = BT_MAX_PAIRED_DEVICE_COUNT,                           \
            ...
            .default_le_mode = 0,                           \
            .support_switch_role = TRUE,                    \
            .support_all_event_report=0,                    \
            .scan_interval_value = 0x0800,                  \
            .scan_window_value = 0x0012,                    \
        ...
        .hfp_config =                                       \
        {                                                   \
            .hf_feature = HF_FEATURE_CHOICE,                \
            .ag_feature = AG_FEATURE_CHOICE,                \
            .handle_at_cmd = 1,                             \
            .max_device_nb = 1,                             \
            .msbc_support = MSBC_SUPPOT_FLAG                \
        },                                                  \
        .a2dp_config =                                      \
        {                                                   \
            .media_mtu = 1021,                              \
        ...
        {                                                   \
            .ioCap=NOIN_NOOUT,                              \
            .oobDataFlg=0x00,                               \
            .authReq=SMP_SECURITY_CONNECTION|SMP_BONDING,   \
            .maxEncryptKeySize=0x10,                        \
            .initKeyDistribution=0x07,                      \
            .rspKeyDistribution=0x07,                       \
            .host_calc = FALSE,                             \
            .passkey=123456,                                \
            .pairing_timeout=160                            \
        },                                                  \
        ...
        {                                                   \
            .max_module_num = 10,                           \
            .max_server_connection = 10,                    \
            .max_server_rsp_length = 512,                   \
            .max_server_attribute_length = 512,             \
            .max_server_notification_length = 512,          \
            .max_server_att_value_length = 16,              \
        },                                                  \
        .le_config =                                        \
        {                                                   \
            .cust_mtu = 247,                              \
            ...
            .default_mtu = 23,                              \
            .max_client_num = 10,                           \
            .max_prepare_write_num = 8,                     \
            .max_app_module_num = 10,                       \
        },                                                  \
        .osi_config =                                       \
        {                                                   \
            .task_priority = 24,                            \
...
typedef struct
{
    ...
    bt_stack_osi_config_t osi_config;
} bt_stack_config_t;
# if 0
typedef struct
{
