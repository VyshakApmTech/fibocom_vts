 ...
 **/
//BT COMM CMD
#define BT_COMM_KEYWORD         "AT+BTCOMM="
#define BT_COMM_KEYWORD_LEN     10
...
//BT SPBTTEST
#define BT_SPBTTEST_KEYWORD     "AT+SPBTTEST="
#define BT_SPBTTEST_KEYWORD_LEN    12
#define BT_SPBTTEST_OK          "+SPBTTEST:OK\n"
#define BT_SPBTTEST_ERR         "+SPBTTEST:ERR=error\n"

//BT SPBLETEST
#define BT_SPBLETEST_KEYWORD    "AT+SPBLETEST="
#define BT_SPBLETEST_OK         "+SPBLETEST:OK\n"
#define BT_SPBLETEST_KEYWORD_LEN   13
#define BT_SPBLETEST_ERR        "+SPBLETEST:ERR:ERR=error\n"

//BT SPP CMD
#define BT_SPP_KEYWORD          "AT+BTSPP="
#define BT_SPP_KEYWORD_LEN      9
#define BT_SPP_RESP_ERR         "+BTSPP:ERR="
#define BT_SPP_RESP_OK          "+BTSPP:OK"

//BLE COMM CMD
#define BLE_COMMKEYWORD         "AT+BLECOMM="
#define BLE_COMM_KEYWORD_LEN    11
#define BLE_COMM_RESP_ERR       "+BLECOMM:ERR="
#define BLE_COMM_RESP_OK        "+BLECOMM:OK"

//BLE ADV CMD
#define BLE_ADV_KEYWORD         "AT+BLEADV="
#define BLE_ADV_KEYWORD_LEN     10
#define BLE_ADV_RESP_ERR        "+BLEADV:ERR="
#define BLE_ADV_RESP_OK         "+BLEADV:OK"

//BLE SMP CMD
#define BLE_SMP_KEYWORD         "AT+BLESMP="
#define BLE_SMP_KEYWORD_LEN     10
#define BLE_SMP_RESP_ERR        "+BLESMP:ERR="
#define BLE_SMP_RESP_OK         "+BLESMP:OK"

//BLE SCAN CMD
#define BLE_SCAN_KEYWORD        "AT+BLESCAN="
#define BLE_SCAN_KEYWORD_LEN    11
