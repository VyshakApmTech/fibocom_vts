...
#define AT_LOCKED_PLMN_NUM 30
typedef struct
{
    uint8_t nStatus;
    uint8_t plmnNum;
    uint8_t plmnList[AT_LOCKED_PLMN_NUM * 6];
} atLockedPlmnSetting_t;
...
typedef struct
{
    ...
    atLockedPlmnSetting_t lockedPlmn;
#endif
...
extern const bool gAtEchoDeviceCommandLine;
extern const unsigned gAtDispatchFetchBufSize;
