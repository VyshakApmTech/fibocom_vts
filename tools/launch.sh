...
function compiler_select
{
    ...
    if [[ $BUILD_TARGET =~ "8850" ]] || [[ $BUILD_TARGET =~ "MC66" ]] || [[ $BUILD_TARGET =~ "MG66" ]] || [[ $BUILD_TARGET =~ "8860" ]] || [[ $BUILD_TARGET =~ "8910" ]]; then
...
if [ -z "$1" ]; then
    ...
    if [[ $BUILD_TARGET =~ "8850" ]] || [[ $BUILD_TARGET =~ "MC66" ]] || [[ $BUILD_TARGET =~ "MG66" ]] || [[ $BUILD_TARGET =~ "8910" ]]; then
        COMPLIER_DEFAULT=gcc-arm-none-eabi-10.2.1
    else
        COMPLIER_DEFAULT=gcc-arm-none-eabi-9.2.1
    fi
